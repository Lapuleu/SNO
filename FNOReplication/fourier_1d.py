...
from Futilities3 import MatReader, LpLoss   # keep same as LNO
...
results_dir = os.path.join(current_directory, "Case_Flor10_" + str(save_index))
...
reader = MatReader('/workspace/Data/Lorenz10/data.mat')
